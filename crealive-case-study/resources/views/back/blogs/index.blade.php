        ...
        <div class="container">
            ...
            <section>
                ...
                <div class="d-flex flex-row bd-highlight mb-3 justify-content-between">
                    <div class="p-2 bd-highlight flex-grow-1 align-self-end">
                        <h5><strong>Bloglar</strong></h5>
                    </div>
                    <div class="p-2 bd-highlight">
                        <a href="{{ route("back.blogs.create") }}" class="btn btn-success my-btn">Blog Ekle</a>
                    </div>
                    <div class="p-2 bd-highlight">
                        <a href="{{ route("back.trash.blog") }}" class="btn btn-warning my-btn">Silinen Bloglar</a>
                    </div>
                </div>
                <div class="row">
                    <div class="table-responsive">
                        <table class="table table-hover caption-top">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="text-center">Görüntüle</th>
                                ...
                                @foreach($blogs as $blog)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a target="_blank" href="{{ route("blog-detail", [$blog->getCategory->name_seo, $blog->name_seo]) }}">
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route("back.blogs.edit", $blog->id) }}">
                                        ...
                                        <td class="text-end">
                                            <a class="" style="cursor: pointer" href="{{ route("back.delete.blog", $blog->id) }}">
